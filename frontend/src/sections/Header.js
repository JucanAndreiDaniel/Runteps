            ...
            >
                <Toolbar sx={{ flexWrap: 'wrap' }}>
                    <Typography variant="h6" color="inherit" noWrap sx={{ flexGrow: 1 }}>
                        <Link to="/">
                            <Button size="small">Runteps</Button>
                        </Link>
                    </Typography>
                    <Link to="/login">
            ...
            >
                <Toolbar sx={{ flexWrap: 'wrap' }}>
                    ...
                    <div>
                        ...
                        >
                            <MenuItem onClick={handleUserDropdownCloseClick}>Create a new Course</MenuItem>
                        ...
                        >
                            <MenuItem onClick={handleUserDropdownCloseClick}>Profile</MenuItem>
